        ...
        <div class="content">
            <table>
                ...
                <tr>
                    ...
                    <td class="td-center"><a href="registeredCitizenView.php?user_id=<?php echo $rowFetch1['user_id']; ?>"><i class="fas fa-eye" id="view<?php echo $rowFetch1['user_id']; ?>"></i></a></td>
                </tr>
                <?php
                    ...
                    <tr>
                        ...
                        <td class="td-center"><a href="registeredCitizenView.php?user_id=<?php echo $rowFetch['user_id']; ?>"><i class="fas fa-eye" id="view<?php echo $rowFetch['user_id']; ?>"></i></a></td>
                    </tr>
                    <?php
