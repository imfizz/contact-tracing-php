        ...
        <div class="content">
            <table>
                ...
                <tr>
                    ...
                    <td class="td-center"><a href="registeredEstablishmentView.php?user_id=<?php echo $rowFetch1['establishment']; ?>"><i class="fas fa-eye" id="view<?php echo $rowFetch1['establishment']; ?>"></i></a></td>
                </tr>
                <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $rowFetch['registrationNo']; ?></td>
                        <td><?php echo $rowFetch['email']; ?></td>
                        <td class="td-center"><a href="registeredEstablishmentView.php?user_id=<?php echo $rowFetch['establishment_id']; ?>"><i class="fas fa-eye" id="view<?php echo $rowFetch['establishment_id']; ?>"></i></a></td>
                    </tr>
                    <?php
