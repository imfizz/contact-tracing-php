...
if(isset($_POST['reject_btn'])){
    ...
    $message = "Your registration in iTrace is not valid. You can register again and make sure to have a valid information to get vaccinated.";
        ...
        if(!$mail->send()){
            ...
            $sqlEmail = "DELETE FROM [dbo].[user] WHERE user_id = $user_id";
            ...
            <div class="wrapper">
                <form method="get" action="makeID.php">
                    ...
                    ?>
                        ...
                        <input type="hidden" name="user_id" value="<?php echo $rowFetch['user_id']; ?>">
                        <input type="" name="citizen_key" value="<?php echo $rowFetch['contactNo'].$rowFetch['user_id']; ?>">
